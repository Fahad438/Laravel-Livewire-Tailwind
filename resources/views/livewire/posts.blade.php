...
<x-banner />
    ...
    <div class=" p-2">
        <x-button wire:click="showCreatePostModal">Crate Post</x-button>
    </div>
        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="w-full divide-y divide-gray-200 ">
                    <thead class="bg-gray-50 dark:bg-gray-600 dark:text-gray-200 dark:bg-gray-800">
                        <tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right text-sm">
              <x-button wire:click="showEditPostModal({{ $post->id }})" class="bg-green-500">Edit</x-button>
              <x-button wire:click="deletePost({{ $post->id}})" class="bg-red-700">Delete</x-button>
            </td>
          </tr>
          @endforeach
                    </tbody>
